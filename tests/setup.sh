...
archive_file=$name-v$holdinvoice_version-$platform_file_end

github_url="https://github.com/daywalker90/holdinvoice/releases/download/v$holdinvoice_version/$archive_file"
